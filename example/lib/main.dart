...
class _MyAppState extends State<MyApp> {
  ...
  final _cutterMachinePlugin = CutterMachine();
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(onPressed: ()async{
                      ...
                      var res = await _cutterMachinePlugin.cutFileWithHeightAndWidthBluetooth(file, xoffset: 50, yoffset: 50, width: 50, height: 50,yflip: true,xflip: true,section: true);
                      print(res);
